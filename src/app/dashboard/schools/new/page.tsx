...
export default function NewSchoolPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // 2. Upload Logo
      toast.loading('Uploading brand assets...', { id: 'provision' });
      ...
      // 3. Create Admin
      toast.loading('Creating admin user...', { id: 'provision' });
      await api.post(`/schools/${slug}/admin`, {
        email: adminEmail,
        password: adminPassword,
      });
      
      toast.success('Successfully provisioned new school!', { id: 'provision' });
      setTimeout(() => {
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <section>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    School Logo (Square PNG/JPG, Min 512x512 recommended)
                  </label>
                  <input
                    type="file"
                    required
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      The admin will be prompted to change this on their first login.
                    </p>
                  </div>
                </div>
              </section>
